...
async def get_tasks(request: Request, db: AsyncSession = Depends(get_db), current_user: User = Depends(get_current_user)):
...
async def create_task(request: Request,
                      title: str = Form(), status: str = Form(default=task_status.PLANNED), description: str = Form(None),
                      plan_date: str = Form(),
...
@router.get('/edit/{task_id}/', response_model=ToDoResponse)
...
@router.post('/update/{task_id}/', response_model=RedirectResponse)
async def update_task(request: Request, task_id: int, title: str = Form(), status: str = Form(default=task_status.PLANNED),
